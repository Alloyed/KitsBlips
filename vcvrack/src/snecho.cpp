...
struct Snecho : Module
{
    ...
    Snecho()
    {
        ...
        configParam(DELAY_MOD_PARAM, 0.f, 1.f, 0.f, "");
        configParam(FREEZE_PARAM, 0.f, 1.f, 0.f, "");
        configParam(CLEAR_PARAM, 0.f, 1.f, 0.f, "");
        configParam(RESET_PARAM, 0.f, 1.f, 0.f, "");
        configInput(MIX_CV_INPUT, "");
        configInput(DELAY_MOD_CV_INPUT, "");
        configInput(FEEDBACK_CV_INPUT, "");
        configInput(DELAY_CV_INPUT, "");
        configInput(FREEZE_CV_INPUT, "");
        configInput(CLEAR_CV_INPUT, "");
        configInput(RESET_CV_INPUT, "");
        configInput(AUDIO_L_INPUT, "");
        configInput(AUDIO_R_INPUT, "");
        configOutput(AUDIO_L_OUTPUT, "");
        configOutput(AUDIO_R_OUTPUT, "");
