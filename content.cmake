...
function(target_enable_asan target_name)
    ...
    # force off - this flag breaks under asan
    set(CORRADE_CPU_USE_IFUNC OFF CACHE BOOL "" FORCE)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        target_compile_options(${target_name} PRIVATE -O1 -g -fsanitize=address -fno-omit-frame-pointer -fno-optimize-sibling-calls)
        target_link_options(${target_name} PRIVATE -fsanitize=address -shared-libasan)
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        ...
        message(FATAL_ERROR "ASAN enabled but not supported on current compiler")
    endif()
    message(STATUS "AddressSanitizer enabled")
endfunction()

function(target_enable_msan target_name)
    # https://clang.llvm.org/docs/MemorySanitizer.html
    if (NOT CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        message(FATAL_ERROR "MemorySanitizer enabled, so we need to use clang.")
    endif()
    target_compile_options(${target_name} PRIVATE -O1 -g -fsanitize=memory -fsanitize-memory-track-origins -fno-omit-frame-pointer -fno-optimize-sibling-calls)
    target_link_options(${target_name} PRIVATE -fsanitize=memory)
    set(CORRADE_CPU_USE_IFUNC OFF CACHE BOOL "" FORCE)
    message(STATUS "MemorySanitizer enabled")
endfunction()

function(target_enable_tsan target_name)
