...
function(target_add_bundle TARGET_NAME ASSETS_DIR)
    ...
    add_custom_target(${TARGET_NAME}_assets SOURCES ${GLOBBED_ASSETS})
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} -E cat "${TARGET_FILE}" "${ZIP_FILE}" > "${TARGET_FILE}"
        COMMENT "adding asset bundle to: ${TARGET_FILE}"
        VERBATIM
    )
endfunction()
