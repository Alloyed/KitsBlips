...
struct Config
{
    // [0, 1]: rounded up to nearest 16 ms, up to kMaxEchoMs. corresponds to the EDL register
    ...
    float echoFeedback;
    // [0, 1]: moves the read head up/down up to 16 ms. can be used for chorus-y effects. (extension, not available on
    // original hardware)
    float echoDelayMod;
